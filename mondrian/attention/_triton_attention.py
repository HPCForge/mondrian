...
LN2: tl.constexpr = 0.6931471805
LN2_INV: tl.constexpr = 1.4426950408889634
...
def _attn_bwd(
    ...
    if CAUSAL:
        ...
        # if non-causal, we compute entirety of dk, dv
        start_m = 0
    ...
    if CAUSAL:
        # if causal, only compute up to the diagonal.
        ...
        # if non-causal, compute entirety of dq
        start_n = 0
...
class _attention(torch.autograd.Function):
    ...
    def backward(ctx, do):
        ...
        BLK_SLICE_FACTOR = 2
        arg_k = k
        arg_k = arg_k * (ctx.sm_scale * LN2_INV)
        PRE_BLOCK = 128
