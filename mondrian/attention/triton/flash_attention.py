"""
This is a modification of the triton tutorial that implements
Flash Attention v2 from Tri Dao (https://tridao.me/publications/flash2/flash2.pdf)
The main modifications are removing support for causal attention
and enabling non-causal attention in the backward pass.
...
def bench_flash_attention(
    ...
    if provider == "flash":
        qkv = torch.randn(
            (BATCH, N_CTX, 3, H, HEAD_DIM), dtype=dtype, device=device, requires_grad=True
        )
