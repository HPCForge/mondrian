r"""
climatelearn code uses lightning 1.9, we use 2.0. This version 
difference was causing errors. The only necessary change is that the import
changes from `import pytorch_lighting` to `lightning`.
"""
