...
class SubDomainPadding(nn.Module):
    ...
    `(batch-size, num-subdomains, channels, d1, ...., dN)`
    """
    ...
    def unpad(self, x):
        ...
        unpad_indices = self._unpad_indices[f"{list(x.shape[3:])}"]
