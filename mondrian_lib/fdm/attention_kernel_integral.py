r"""
Taken from master branch of neuralop:
https://github.com/neuraloperator/neuraloperator/blob/main/neuralop/layers/attention_kernel_integral.py
a little wary about directly using master since it's had issues in the past.
"""
