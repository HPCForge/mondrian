...
from mondrian.models.transformer.galerkin_transformer_2d import GalerkinTransformer2d
...
def test_galerkin_transformer_forward(device):
    vo = GalerkinTransformer2d(
        in_channels=32, out_channels=32, embed_dim=16, num_heads=4, num_layers=4, quadrature_method='reimann'
    ).to(device)
